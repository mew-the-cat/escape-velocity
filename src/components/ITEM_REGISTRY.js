...
export const generateItem = () => {
  ...
  for (let frequency = 0; frequency<(SETTINGS.ITEM_SEARCH_FREQUENCY_THRESHOLDS.length-1); frequency++){
    if (randomNumber > SETTINGS.ITEM_SEARCH_FREQUENCY_THRESHOLDS[frequency] && randomNumber < SETTINGS.ITEM_SEARCH_FREQUENCY_THRESHOLDS[frequency+1]) {
